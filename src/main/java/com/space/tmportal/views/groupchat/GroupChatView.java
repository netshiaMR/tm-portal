package com.space.tmportal.views.groupchat;
...
@AnonymousAllowed
public class GroupChatView extends HorizontalLayout {
    ...
    public GroupChatView() {
        addClassNames("group-chat-view", Width.FULL, Display.FLEX, Flex.AUTO);
        setSpacing(false);
